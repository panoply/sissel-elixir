defmodule ApiWeb.SectionControllerTest do
  use ApiWeb.ConnCase

  alias Api.Sissel
  alias Api.Sissel.Section

  @create_attrs %{content: "some content", page: "some page", title: "some title"}
  ...
  def fixture(:section) do
    {:ok, section} = Sissel.create_section(@create_attrs)
    section
  end
